...
function build_drogon() {
    ...
    if [ $1 -eq 1 ]; then
        cmake .. -DCMAKE_INSTALL_PREFIX=/home/calvin/.local -DBUILD_TESTING=YES $cmake_gen
    else
        cmake .. -DCMAKE_INSTALL_PREFIX=/home/calvin/.local -DCMAKE_BUILD_TYPE=release $cmake_gen
    fi
